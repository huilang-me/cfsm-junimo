...
export const PublicConfigSchema = z
  .object({
    ...
    custom_ct_name: z.string().default(""),
    custom_cu_name: z.string().default(""),
    custom_cm_name: z.string().default(""),
    custom_bd_name: z.string().default(""),
    node_1_name: z.string().default(""),
    node_2_name: z.string().default(""),
    node_3_name: z.string().default(""),
    node_4_name: z.string().default(""),
